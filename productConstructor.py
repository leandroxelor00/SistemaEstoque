...
def main(page: ft.Page):
    ...
    marca_produto= campo(
        "Marca",
        ft.Icons.BRANDING_WATERMARK_OUTLINED
    )
    preco_produto = campo(
        "Preço",
    ...
    def salvar_produto(e):
        ...
        tabela_produtos.rows.append(
            ft.DataRow(
                cells=[
                    ft.DataCell(
                        ft.Text(produto["Nome"], color= "white")
                    ),
                    ft.DataCell(
                        ft.Text(produto["Marca"], color= "white")
                    ),
                    ft.DataCell(
                        ft.Text(produto["Preço"], color="white")
                    ),
                ]
            )
        )
            ...
            ft.Column(
                ...
                controls=[
                    ...
                    ft.Row(
                        spacing=15,
                        controls=[
                            botao_primario("Salvar", ft.Icons.SAVE, salvar_produto),
